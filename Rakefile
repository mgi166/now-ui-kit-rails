...
namespace :now_ui_kit do
  ...
  task :upgrade do
    Dir.mktmpdir do |dir|
      ...
      sh "mv #{dir}/now-ui-kit-master/assets/fonts/* app/assets/fonts/now_ui_kit", verbose: true
      ...
      sh "mv #{dir}/now-ui-kit-master/assets/sass/* app/assets/stylesheets/now_ui_kit", verbose: true
    end
  end
end
